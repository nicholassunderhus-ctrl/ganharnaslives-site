...
const RecompensaVerAnuncio2Page = () => {
  const navigate = useNavigate();

  useEffect(() => {
    // 1. Define um indicador no localStorage para liberar a missão "Ver Anúncio 2"
    localStorage.setItem('ver_anuncio_2_liberado', 'true');
...
export default RecompensaVerAnuncio2Page;