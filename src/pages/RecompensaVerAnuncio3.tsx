...
const RecompensaVerAnuncio3Page = () => {
  const navigate = useNavigate();

  useEffect(() => {
    // 1. Define um indicador no localStorage para liberar a missão "Ver Anúncio 3"
    localStorage.setItem('ver_anuncio_3_liberado', 'true');
...
export default RecompensaVerAnuncio3Page;